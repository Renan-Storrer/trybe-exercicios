...
Neste exercício você vai desenvolver três componentes (`Header`, `Content` e `Footer`), que serão utilizados para renderizar o conteúdo de um array.
...
- Use o comando: `git clone git@github.com:tryber/sd-024-b-exercise-frontend-content.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-0x-exercise-frontend-content`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-0x-exercise-frontend-content`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-0x-exercise-frontend-content`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-0x-exercise-frontend-content/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-0x-exercise-frontend-content/pulls) e confira que o seu _Pull Request_ está criado
...
- O componente foi criado na pasta correta e renderiza uma tag `h1`;

- A tag `h1` é renderizada no App com o texto 'Conteúdos de Frontend';
...
- Lembre-se de adicionar o atributo `key` a cada elemento do array a ser renderizado.

<details>
  <summary><strong>O que será verificado</strong></summary><br />

- O componente `Content` foi criado na pasta correta e renderiza uma `ul`;

- O componente `Content` é renderizado no `App` e com as mensagens corretas;
...
- A tag footer precisa de o atributo `data-testid="footer"`
...
- O componente `Footer` foi criado na pasta correta e renderiza uma tag `footer`;

- O componente `Footer` é renderizado na tela com a mensagem correta dentro de uma tag `h3`;
...
<details>
  <summary>Estilize a aplicação adicionando classes para estilização dos seus componentes de forma que cada conteúdo listado seja um Card</summary><br />
